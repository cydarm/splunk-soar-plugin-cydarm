...
ACTIONS = [
    ...
    generate_action(
        action_name="quick search cases",
    ...
    #                 ),
    generate_action(
        action_name="create action comment",
        ...
        parameters=generate_input_params_dict(
            [
                InputParam(name="action_instance_uuid", description="UUID of action instance.", required=True),
                InputParam(name="data", description="Comment to add to action instance.", required=True),
            ]
        ),
        output=OUTPUT_STATUS_MESSAGE_SUMMARY + OUTPUT_ACTION_INSTANCE_DATA_MODEL,
    ),
    generate_action(
        action_name="create case comment",
        identifier="create_case_data_comment",
        description="Create a plaintext comment on a case",
        read_only=False,
        parameters=generate_input_params_dict(
            [
                InputParam(name="case_uuid", description="UUID of the case", required=True),
                InputParam(name="data", description="Comment text", required=True),
            ]
        ),
    ...
    generate_action(
        ...
        read_only=False,
        parameters=generate_input_params_dict([InputParam(name="case_uuid", description="Case UUID", required=True), *INPUT_PARAMS_UPDATE_CASE]),
    ...
    generate_action(
        ...
        parameters=generate_input_params_dict(
            [
                ...
                InputParam(name="playbook_uuid", description="Playbook UUID", required=True),
            ]
        ),
        output=OUTPUT_STATUS_MESSAGE_SUMMARY + OUTPUT_UUID_AND_ACL_MODEL,
    ),
    generate_action(
        ...
        parameters=generate_input_params_dict(
            [
                InputParam(name="case_uuid", description="Case UUID", required=True),
                InputParam(name="case_playbook_uuid", description="Case Playbook instance UUID", required=True),
            ]
        ),
    ...
    generate_action(
        ...
        parameters=generate_input_params_dict(
            [
                InputParam(name="action_uuid", description="UUID of the action", required=True),
            ]
        ),
    ...
    generate_action(
        action_name="add playbook action",
    ...
    generate_action(
        ...
        parameters=generate_input_params_dict(
            [
                InputParam(name="case_uuid", description="Case UUID", required=True),
                InputParam(name="member_case_uuid", description="UUID of case to add as a member of the case group", required=True),
            ]
        ),
        output=OUTPUT_STATUS_MESSAGE_SUMMARY + OUTPUT_UUID_AND_ACL_MODEL,
    ),
